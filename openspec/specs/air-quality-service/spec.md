...
Provide a stable local HTTP interface for current air-quality context so the BFF can consume normalized data without calling the Open-Meteo Air Quality API directly.
